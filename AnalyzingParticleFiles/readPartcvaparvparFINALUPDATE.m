...
folderName = '17';
loaddir = ['/ext/VPICRuns/MagneticPumping/1DCollChgAmpDecr/Big/1Dnu10/'];
savedir = ['/ext/VPICRuns/MagneticPumping/1DCollChgAmpDecr/Big/1Dnu10/particlesDist'];
...
Ndiv = 1;%5;                                                                   % Number of divisions on the z direction
Ndivk = 1;%32;                                                                 % Number of divisions in the x direction
...
%     if i == 2
%         Npart = 35328000;%34686000;%31160000;%33944000;%32378000; 
%     elseif i == 3
%         Npart = 53888000;%50006000;%49778000;
%     elseif i == 4
%         Npart = 30974000;%36900000;%35238000;%34180000;%36902000; 
%     elseif i == 5
%         Npart = 49586000;%4910800000;%484660000;%49546000;%48600000;
%     elseif i == 6
%         Npart = 35726000;%34090000;%35026000;%32294000;%35388000;
%     elseif i == 7
%         Npart = 51324000;%5275800000;%50586000;%488740000;
%     elseif i == 8
%         Npart =  32898000;%33598000;%35278000;%36120000;%33746000;
%     elseif i == 9
%         Npart =  51684000;%4916200000;%35278000;%36120000;%33746000;
%     elseif i == 10
%         Npart = 36752000;%34602000;%35734000;%32668000;
%     elseif i == 11
%         Npart = 50590000;%527980000;%35734000;%32668000;
%     elseif i == 12
%         Npart = 33228000;%35426000;%32820000;%35920000;%32634000;
%     elseif i == 13
%         Npart = 51900000;%492160000;%50064000;%49352000;
%     elseif i == 14
%         Npart = 35178000;%32888000;%34100000;%35772000;
%     elseif i == 15
%         Npart = 50458000;%51928000;%50384000;%35772000;
%     elseif i == 16
%         Npart = 34672000;%34512000;%32226000;%34034000;%33670000;
%     elseif i == 17
%         Npart = 51672000;%50710000;%506220000;
%     elseif i == 18
%         Npart = 34562000;%33912000;%33074000;%35106000;%33264000;
% %     elseif (i == 11 || i == 13)
% %         Npart = 50184000;
% %     elseif (i == 17)
% %         Npart = 51120000;
%     elseif (i == 19)
%         Npart = 49638000;%51010000;%51186000;%51614000;%485320000;
%     elseif (i == 20)
%         Npart = 36002000;
%     elseif (i == 21)
%         Npart = 48994000;
%     end
    ...
    k = 1;
    while (fseek(f,(Nskip*k)*5*4,'bof') ~= -1)
...
%     end
    ...
    %eval (['cd /home/lichko/VPICRuns/AlfvenWaves/ReadingInParticlesFinalFiles_SmallSlices/']);  
    ...
    nZLevels = ((maxZAbs - minZAbs)/Zbloc/dz);
    ...
    while (k1<(nZLevels))
        ...
        elseif (numel(tempdiffIIVar) == 3 && k1 == 1)
            ...
            k1 = k1+3;
        elseif (numel(tempdiffIIVar) == 3 && k1+3 <= nZLevels)
            zBnds(k1+1) = tempdiffIIVar(1);
            zBnds(k1+2) = tempdiffIIVar(2);
            zBnds(k1+3) = tempdiffIIVar(3);
            k1 = k1+3;
        elseif (numel(tempdiffIIVar) == 4 && k1+4 <= nZLevels)
            zBnds(k1+1) = tempdiffIIVar(1);
            zBnds(k1+2) = tempdiffIIVar(2);
            zBnds(k1+3) = tempdiffIIVar(3);
            zBnds(k1+4) = tempdiffIIVar(4);
            k1 = k1+4;
        elseif (numel(tempdiffIIVar) == 5 && k1+5 <= nZLevels)
            zBnds(k1+1) = tempdiffIIVar(1);
            zBnds(k1+2) = tempdiffIIVar(2);
            zBnds(k1+3) = tempdiffIIVar(3);
            zBnds(k1+4) = tempdiffIIVar(4);
            zBnds(k1+5) = tempdiffIIVar(5);
            k1 = k1+5;
        else
    ...
    for k=[1:(NBdk-1) (NBdk+1):Nnum]
        ...
        if k <= (NBdk-1)
            IIX=find(dum(1:5:end)>((k-kMax)*(((maxXAbs - minXAbs)/nXLevels))));
        else
            IIX=find(dum(1:5:end)>(((k-NBdk)-kMax)*((maxXAbs - minXAbs)/nXLevels)));
        end
        if (numel(IIX) ~= 0)
            Nbound1b(k)=(Nbound1(k)-2)*Nskip+IIX(1);
        else
            Nbound1b(k) = Nbound1b(k-1) + (Nbound1b(k-1) - Nbound1b(k-2)); 
        end
    end
    if NBdk > 2
    ...
    for k=kstart:kend
        ...
        if ((k ~= kend && Ndiv == 1 && Ndivk == 1) || (k ~= kstart && Ndiv ~= 1 && Ndivk ~= 1))
            for n1 = 1:Ndivk
                for l = 0:(Ndiv-1)
